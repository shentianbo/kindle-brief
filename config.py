...
CHAPTERS = [
    ...
    # ── 章节3：心理学 · 依恋与人格 ───────────────────────────
    {
        ...
        "use_fulltext": True,
        "max_per_feed": 3,
        # 只保留与依恋/人格/亲密关系相关的文章，其他跳过
        "keywords": [
            "attachment", "avoidant", "anxious", "secure", "insecure",
            "personality", "narciss", "dark triad", "Big Five", "MBTI",
            "intimate", "relationship", "emotion", "self-esteem",
            "trauma", "bonding", "love", "breakup", "infidelity",
            "rejection", "abandonment", "codepend", "borderline",
        ],
        "feeds": [
...
注意：
1. 内容太短或质量差的文章直接跳过
2. 输出纯文本 + 基本 Markdown，不要 HTML 标签
3. 文章之间用 --- 分隔"""
